...
$(function () {
  ...
  if (dt_invoice_table.length) {
    var dt_invoice = dt_invoice_table.DataTable({
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="javascript:;" data-bs-toggle="tooltip" class="text-body d-none" data-bs-placement="top" title="Send Mail"><i class="bx bx-send mx-1"></i></a>' +
              '<a href="' +
              baseUrl +
              'app/invoice/preview" data-bs-toggle="tooltip" class="text-body d-none" data-bs-placement="top" title="Preview Invoice"><i class="bx bx-show mx-1"></i></a>' +
              '<div class="dropdown">' +
              ...
              '<a href="' +
              baseUrl +
              'app/invoice/preview" class="dropdown-item">View</a>' +
              '<a href="javascript:;" class="dropdown-item d-none">Duplicate</a>' +
              '<div class="dropdown-divider d-none"></div>' +
              '<a href="javascript:;" class="dropdown-item delete-record text-danger d-none">Delete</a>' +
              '</div>' +
              '</div>' +
              '</div>'
            );
      ...
      dom:
        '<"row ms-2 me-3"' +
        '<"col-12 col-md-6 d-flex align-items-center justify-content-center justify-content-md-start gap-2"l<"dt-action-buttons text-xl-end text-lg-start text-md-end text-start mt-md-0 mt-3 d-none"B>>' +
