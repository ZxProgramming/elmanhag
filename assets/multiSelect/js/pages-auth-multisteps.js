...
$(function () {
    ...
    e.length &&
        e.each(function () {
            var e = $(this);
            e.wrap('<div class="position-relative"></div>'), e.select2({ placeholder: "Select a country", dropdownParent: e.parent() });
        });
}),
        ...
        if (null !== n) {
            ...
            const p = FormValidation.formValidation(c, {
                    fields: {
                        agency_name: {
                            validators: {
                                notEmpty: { message: "Agency Name is required" },
                            },
                        },
                        contact_email: {
                            validators: {
                                notEmpty: { message: "Contact Email is required" },
                                emailAddress: { message: "Invalid Contact Email" },
                            },
                        },
                        contact_phone: {
                            validators: {
                        ...
                        agency_address: {
                            validators: {
                                notEmpty: { message: "Agency Address is required" },
                            },
                        },
                        country: {
                            validators: {
