...
<div class="card">
    ...
    @section('content')
        ...
        <!-- Basic Layout -->
            {{-- Section 1 --}}
            <form method="POST" action="{{route('materialAdd')}}">
                @csrf
            ...
            <div class="container section3 mt-3 par d-none" id="chi4">
                  <div class="col-md-12 row">
                        ...
                        <div class="col-md-4 d-flex align-items-start chi-section2" style="justify-content: space-evenly;">
                                ...
                                <div class="col-md-6 pa-duration">
                                    ...
                                    <div class="row" id="duration-1">
                                        <div class="col-md-7">
                                            <input name="u_progress_date4" type="date" id="dat-ve1" class="form-control u_progress_date4"/>
                                        </div>
                                        
                                        <div class="col-md-5 p-0">
                                            <input name="u_duration4" type="number" id="duration-ve1" class="form-control u_duration4" style="width: 75px;" placeholder="Duration"/>
                                        </div>
                        ...
                        <div class="col-md-4 d-flex align-items-start chi-section3" style="gap: 10px"> 
                            ...
                            <div class="col-md-4">
                                <input name="u_done_date4" type="date" id="dat-done-ve" class="form-control u_done_date4"/>
                            </div>
                            <div class="col-md-5 d-flex align-items-center">
                                <span class="col-md-6 px-1">Duration</span>
                                <input name="u_done_duration4" id="dur-done-ve" style="width: 75px" class="form-control u_done_duration4" placeholder="Duration"/>
                            </div>
                        </div>
                            {{-- chi-section3 --}}
            ...
            <div class="container d-flex flex-column mt-3 par d-none" style="gap: 10px" id="chi5">
                <div class="col-md-12 row chi2">
                        ...
                        <div class="col-md-4 d-flex align-items-center chi-section2">
                            ...
                            <div class="col-md-6">
                                <input type="date" name="progress_date5" id="dat-vl" class="form-control progress_date5"/>
                            </div>
                        </div>
                            {{-- chi-section2 --}}
                        ...
                        <div class="col-md-4 d-flex align-items-center chi-section3" style="gap: 10px">
                            ...
                            <div class="col-md-4">
                                <input type="date" name="done_date5" id="dat-done-vl" class="form-control done_date5"/>
                            </div>
                           <div class="col-md-5 d-flex align-items-center">
                                <span class="col-md-4 px-1">Size</span>
                                <input name="done_duration5" id="siz-vf-vl" style="width: 75px" class="form-control done_duration5" placeholder="Size"/>
                            </div>
                        </div>
                            {{-- chi-section3 --}}
