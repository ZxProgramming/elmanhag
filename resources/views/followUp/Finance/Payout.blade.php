...
<div class="card">
    ...
    @section('content')
        ...
        <div class="container pay-container">
            <div class="col-md-12 pay-par d-flex justify-content-center">
                {{-- Balance --}}
            ...
            {{-- Pop-Up --}}
                ...
                <form action="{{route('FPayoutAdd')}}" method="POST" class="modal fade" id="exampleModal" 
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="pop-con mt-2">
                                ...
                                <div class="chil-con">
                                    <input type="number" name="pay-number" id="available" value="{{$balance}}" readonly>
                                    <span>EGP</span>
                                </div>
                            </div>
